...
<head>
	...
	<meta charset="UTF-8">
	<!-- Site Title -->
	<title>Bandara Abdur Rachman Saleh</title>
			...
			<div class="container">
				<div class="row fullscreen d-flex align-items-center justify-content-center">
					<div class="banner-content col-lg-12 col-md-12">
						<h6 class="text-uppercase">Aman, Nyaman & Terpercaya</h6>
						<h1>
							Bandar Udara Abdul Rachman Saleh			
						</h1>
						<p class="text-white">
							Bandar Udara Abdul Rachman Saleh adalah bandar udara yang terletak di Pakis, Kabupaten Malang<br> Jawa Timur, atau 17 km arah timur dari pusat Kota Malang. 
						</p>
						<a href="#" class="primary-btn header-btn text-uppercase">Mulai</a>
					</div>												
				</div>
			</div>
		</section>
